/**
 * Defines optional environment globals used for worker capability detection.
 */
...
/**
 * Detects worker capabilities from the provided environment snapshot.
...
/**
 * Resolves one safe worker mode according to required and preferred options.
