import type { EnginePoint, EngineRect, EngineSceneSnapshot, EngineTextNode } from '../../scene/types/types.ts';
...
export interface EngineRenderStats {
    ...
    strategySnapshotFallbackReason?: import("../fallbackTaxonomy/index.ts").EngineRenderFallbackReason | null;
