/**
 * Renderer/WebGL composite module.
 * Owns framebuffer snapshot capture and composite texture replay primitives.
 * Does not own capability state persistence or backend frame orchestration.
 */
import type { EngineRenderFrame } from '../types/types.ts'
import { drawWebGLPacket, type WebGLQuadPipeline } from '../webgl/core/pipeline.ts'
...
/**
 * Handles resolveCompositeSnapshotPixelRatio.
...
/**
 * Handles resolveCompositeTexturePresentationFlipY.
 * @param textureSource textureSource parameter.
 */
...
/**
 * Handles drawCompositeTextureFrame.
...
/**
 * Handles captureCompositeSnapshotFromCurrentFramebuffer.
 * @param options Options object for this operation.
 */
