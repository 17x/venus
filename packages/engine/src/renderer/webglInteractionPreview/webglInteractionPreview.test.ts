...
function createFakePipeline() {
  return {} as unknown as import('../webgl/core/pipeline.ts').WebGLQuadPipeline
}
...
*/
function createSnapshot(overrides?: Partial<import('../webglComposite/webglComposite.ts').InteractionCompositeSnapshot>) {
  return {
    revision: 1,
    scale: 1,
    offsetX: 0,
