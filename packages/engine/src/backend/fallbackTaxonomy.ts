// Canonical fallback reason taxonomy migrated from _oldEngine renderer paths.
export const ENGINE_BACKEND_CACHE_FALLBACK_REASON = {
  NONE: "none",
...
// Union type used by backend diagnostics fields that classify cache fallback causes.
export type EngineBackendCacheFallbackReason =
  (typeof ENGINE_BACKEND_CACHE_FALLBACK_REASON)[keyof typeof ENGINE_BACKEND_CACHE_FALLBACK_REASON];
