...
| ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `renderer/webglComposite`                       | REMOVED 2026-06-29. Stale duplicate of `renderer/webgl/preview/composite`. No importers remained.                                             | ✅ done     |
| `renderer/webglInteractionPreview`              | REMOVED 2026-06-29. Stale duplicate of `renderer/webgl/preview/interaction`. No importers remained.                                           | ✅ done     |
