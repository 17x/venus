...
11. [3D-First Runtime And 2D Opt-In](concepts/3d-first-2d-opt-in.md)
12. [Resource And Asset Ingestion API](api/resource-asset-ingestion.md)
13. [Spatial Query Baseline](api/spatial-query-baseline.md)
14. [Timeline And Replay Baseline](api/timeline-replay-baseline.md)
15. [Backend Capability Matrix](backends/backend-capability-matrix.md)
16. [Release Backend Matrix](backends/release-backend-matrix.md)
17. [Interaction Primitives](editor-integration/interaction-primitives.md)
