...
12. [3D 优先运行时与 2D 显式启用](concepts/3d-first-2d-opt-in.md)
13. [资源与资产接入 API](api/resource-asset-ingestion.md)
14. [空间查询基线](api/spatial-query-baseline.md)
15. [时间线与回放基线](api/timeline-replay-baseline.md)
16. [后端能力矩阵](backends/backend-capability-matrix.md)
17. [发布后端矩阵](backends/release-backend-matrix.md)
18. [交互原语手册](editor-integration/interaction-primitives.md)
19. [场景 Adapter 边界手册](editor-integration/scenario-adapter-boundary-cookbook.md)
20. [Breaking Changes 策略](migration/breaking-changes.md)
21. [App Adapter 迁移指南](migration/app-adapter-migration.md)
22. [Runtime World Navigation And Collision 迁移指南](migration/runtime-world-navigation-collision-migration.md)
23. [预算与 SLO](performance/budgets-and-slos.md)
24. [回放与追踪](diagnostics/replay-and-trace.md)
