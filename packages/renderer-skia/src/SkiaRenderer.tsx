...
import {
  publishSkiaDiagnostics,
  type SkiaRenderDiagnostics,
} from './diagnostics.ts'
...
export function SkiaRenderer({
  ...
  }, [document, renderQuality, sceneIndex, stats.shapeCount, viewport])
...
function drawScene(
  ...
  publishSkiaDiagnostics(diagnostics)
