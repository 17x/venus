...
export const lineSeg = (size = 20) => <svg stroke="currentColor" fill="none" strokeWidth="1" viewBox="0 0 24 24"
...
export const mousePointer = (fill: boolean = true, size = 18) => <svg xmlns="http://www.w3.org/2000/svg"
                                                           strokeLinecap="round"
