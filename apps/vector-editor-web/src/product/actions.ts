import type {EditorEventType} from '../runtime/types/index.ts'

export interface ActionItemType {
  id: string
  // action?: EditorEventType,
  shortcut: string
  editorAction?: EditorEventType,
...
export const EDIT = {
  ...
  children: [
    ...
    {id: 'groupNodes', disabled: false, editorAction: 'group-nodes', shortcut: 'ctrl+g,meta+g'},
    {id: 'ungroupNodes', disabled: false, editorAction: 'ungroup-nodes', shortcut: 'ctrl+shift+g,meta+shift+g'},
...
export const TOOLS = {
  ...
  children: [
    ...
    {id: 'connectorTool', shortcut: 'c', editorAction: 'switch-tool', editorActionData: 'connector'},
    ...
    {id: 'pathTool', shortcut: 'p', editorAction: 'switch-tool', editorActionData: 'path'},
    {id: 'pencilTool', shortcut: 'n', editorAction: 'switch-tool', editorActionData: 'pencil'},
    ...
    {id: 'zoomOutTool', shortcut: 'shift+z', editorAction: 'switch-tool', editorActionData: 'zoomOut'},
