import {getBoundingRectFromBezierPoints, getNormalizedBoundsFromBox, type BezierPoint} from '../geometry/geometry.ts'
...
import {readArrowhead, readBoolean, readGradient, readNumber, readString} from './parseRuntimeScene.readers.ts'
