...
export const EMPTY_RUNTIME_RENDER_DIAGNOSTICS: RuntimeRenderDiagnostics = {
  frameCount: 0,
  diagnosticsUpdatedAtMs: 0,
  frameStageId: 'bootstrap-stage-0',
  frameStageSequence: 0,
  frameStageIssuedAtMs: 0,
  frameStageSchedulerMode: 'normal',
  frameStageSceneApplyMode: 'none',
  drawCount: 0,
  drawMs: 0,
  scenePrepareMs: 0,
  sceneApplyMs: 0,
  ...
  engineBackendRequested: 'auto',
  engineBackendResolved: 'headless',
  engineBackendFallbackReason: null,
  engineRuntimeProfileId: 'unknown',
  engineRuntimeCapabilityCount: 0,
  engineFramePressureReason: 'within-low-thresholds',
  engineFramePressure: 'low',
  engineFramePhase: 'static',
  engineQosDegradationLevel: 'none',
