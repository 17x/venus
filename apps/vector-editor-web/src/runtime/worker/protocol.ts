...
export interface WorkerInitMessage {
  ...
  /** Stores optional crash-recovery replay payload consumed at worker startup. */
  crashRecoveryReplay?: EditorFileHistoryRecoveryReplaySnapshot
  /** Stores startup replay mode used while consuming crash-recovery payloads. */
...
/**
 * Carries command-envelope tracing metadata from runtime command controller to worker history layer.
 */
export interface RuntimeCommandEnvelopeMeta {
  /** Stores stable command id generated by command-envelope factory. */
  commandId: string
  /** Stores transaction id shared by one logical command chain. */
  transactionId: string
  /** Stores command provenance source class. */
...
export type EditorRuntimeCommand =
  ...
  | {
      ...
      toIndex: number
      /**
       * Stores optional isolation-group scope id; when present reorder must stay inside this parent scope.
       */
