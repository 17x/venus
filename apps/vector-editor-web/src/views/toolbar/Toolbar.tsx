...
import {ToolName} from '../../runtime/model/index.ts'
import {
  LuCircle,
  LuHand,
  LuMoveUpRight,
...
const Toolbar: React.FC<{ tool: ToolName, setTool: (t: ToolName) => void }> = ({tool, setTool}) => {
  ...
  return <aside className={'relative flex h-full w-12 shrink-0 flex-col items-center gap-1 bg-slate-50 py-2 dark:bg-slate-950'}>
    {
