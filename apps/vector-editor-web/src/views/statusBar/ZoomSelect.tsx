...
import {RUNTIME_ZOOM_PRESETS} from '../../runtime/index.ts'
import {cn, Tooltip} from '../../ui/index.ts'
...
const ZoomSelect: React.FC<{ scale: number, onChange: (newScale: number | 'fit') => void }> = ({scale, onChange}) => {
  ...
  return <div ref={rootRef} className={'relative'}>
    <div
      className={cn(
        'flex h-5 w-20.5 items-center overflow-hidden rounded bg-white text-slate-800 dark:bg-slate-900 dark:text-slate-100',
