import {Button, Tabs, TabsList, TabsTrigger, Tooltip, useTheme, cn} from '../../ui/index.ts'
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        ...
                        // Keep active/inactive visual treatment local to shell instead of consuming src/ui semantic CSS tokens.
                        active
                          ? 'bg-slate-200 text-slate-900 hover:bg-slate-300 dark:bg-slate-700 dark:text-slate-100 dark:hover:bg-slate-600'
                          : 'bg-transparent text-slate-700 hover:bg-slate-100 hover:text-slate-900 active:text-slate-900 dark:text-slate-200 dark:hover:bg-slate-800 dark:hover:text-slate-50',
                      )}
                    >
                      {tabItem.icon}
                    </span>
