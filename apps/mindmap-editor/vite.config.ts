...
const sharedAliases: ViteAlias[] = [
  ...
  createWorkspaceAlias('@venus/runtime/presets/default', 'packages/runtime/src/presets/presets/defaultEditorModules.ts', repoRootUrl),
  createWorkspaceAlias('@venus/runtime/presets/history', 'packages/runtime/src/presets/presets/history.ts', repoRootUrl),
  createWorkspaceAlias('@venus/runtime/presets/protocol', 'packages/runtime/src/presets/presets/protocol.ts', repoRootUrl),
  createWorkspaceAlias('@venus/runtime/presets/selection', 'packages/runtime/src/presets/presets/selection.ts', repoRootUrl),
  createWorkspaceAlias('@venus/runtime/presets/snapping', 'packages/runtime/src/presets/presets/snapping.ts', repoRootUrl),
  createWorkspaceAlias('@venus/runtime/engine', 'packages/runtime/src/engine.ts', repoRootUrl),
