import type {CityLamp, CityObstacle, CityPathNode, CityRoadSegment, CityWorldMap} from './cityWorldGenerator'
...
export const projectDrivingGameFixture = (fixture: unknown): DrivingGameFixtureProjection => {
  ...
  return {
    ...
    previewSeed: Math.max(0, Math.floor(finite(fixture.previewSeed, 0))),
  }
}
