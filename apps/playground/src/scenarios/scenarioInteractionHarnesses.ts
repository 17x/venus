...
export const PLAYGROUND_SCENARIO_INTERACTION_HARNESSES: readonly PlaygroundScenarioInteractionHarness[] = [
  ...
  {scenarioId: 's10-game-editor-runtime-preview', controls: ['runtime preview step', 'pick node'], telemetry: ['nodes', 'draw', 'previewStep'], deterministicStateKeys: ['revision', 'previewStep']},
