...
export const PLAYGROUND_SCENARIO_INTERACTION_HARNESSES: readonly PlaygroundScenarioInteractionHarness[] = [
  {scenarioId: 's1-medical-volume-slice-runtime', controls: ['slice scrub', 'transfer function', 'ROI pick', 'capture frame', 'fit view'], telemetry: ['nodes', 'draw', 'webglPath', 'sliceIndex'], deterministicStateKeys: ['revision', 'sliceIndex', 'transferPreset', 'selectedRoiId', 'captureId']},
  {scenarioId: 's2-preop-path-simulation', controls: ['edit path', 'path step replay', 'clearance query', 'pick waypoint', 'fit view'], telemetry: ['nodes', 'draw', 'selectedWaypoint', 'clearance'], deterministicStateKeys: ['revision', 'stepIndex', 'editIndex', 'selectedWaypointId', 'clearanceQueryId']},
  ...
  {scenarioId: 's10-game-editor-runtime-preview', controls: ['play preview', 'runtime preview step', 'stop preview', 'reset preview', 'pick node'], telemetry: ['nodes', 'draw', 'previewStep'], deterministicStateKeys: ['revision', 'previewStep']},
